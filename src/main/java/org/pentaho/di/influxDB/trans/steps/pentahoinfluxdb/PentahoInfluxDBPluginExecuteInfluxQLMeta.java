...
@Step(
  id = "PentahoInfluxDBPluginExecuteInfluxQL",
  name = "InfluxDB Execute InfluxQL",
  description = "Execute any InfluxQL qui InfluxDB",
  image = "PentahoInfluxDBPluginExecuteInfluxQL.svg",
...
public class PentahoInfluxDBPluginExecuteInfluxQLMeta extends BaseStepMeta implements StepMetaInterface {
...
*/
  ...
  public PentahoInfluxDBPluginExecuteInfluxQLMeta() {
    super();
  ...
  @Override public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int i, TransMeta transMeta, Trans trans ) {
    return new PentahoInfluxDBPluginExecuteInfluxQL( stepMeta, stepDataInterface, i, transMeta, trans );
  }

  @Override public StepDataInterface getStepData() {
    return new PentahoInfluxDBPluginExecuteInfluxQLData();
  }

  public String getDialogClassName() {
    return PentahoInfluxDBPluginExecuteInfluxQLDialog.class.getName();
  }
  ...
  @Override public void getFields( RowMetaInterface rowMeta, String name, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space,
    ...
    for ( ReturnValue returnValue : returnValues ) {
      try {
		...
		ValueMetaInterface valueMeta = ValueMetaFactory.createValueMeta( "Reponse", type );
